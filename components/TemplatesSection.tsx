  ...
  return (
    <section className="py-20 sm:py-28 bg-gray-50 templates-section">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900">Choose Your Interview Type</h2>
          <p className="text-lg text-gray-600 mt-4">Start practicing with our curated interview templates</p>
        </motion.div>
